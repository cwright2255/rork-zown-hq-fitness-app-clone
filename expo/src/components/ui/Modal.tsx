...
let AnimatedView: React.ComponentType<any> | null = null;
let FadeIn: unknown = null;
let FadeOut: unknown = null;
try {
...
export function Modal({
  ...
  const Content: React.ComponentType<any> = AnimatedView ?? View;
  return (
    <RNModal
      visible={visible}
      transparent
