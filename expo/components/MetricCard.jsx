...
const MetricCard = ({ title, value, target, unit, icon }) => {
  ...
  const renderIcon = () => {
    switch (icon) {
      ...
      case 'flame':
        return <Flame size={24} color={tokens.colors.red.base} />;
      case 'footprints':
      ...
      case 'battery-charging':
        return <BatteryCharging size={24} color={tokens.colors.orange.light} />;
      case 'scale':
        return <Scale size={24} color={tokens.colors.text.base} />;
      case 'beef':
        return <Beef size={24} color={tokens.colors.green.base_84c} />;
      case 'dumbbell':
