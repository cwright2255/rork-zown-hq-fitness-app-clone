...
import { ChevronLeft, ChevronRight, Plus, Calendar, Clock } from 'lucide-react-native';
...
export default function WorkoutCalendar({ onDateSelect, onEventPress, onAddEvent }: WorkoutCalendarProps) {
  ...
  const renderEventDot = useCallback((event, index) => {
    return (
      <View
        key={event.id}
        style={[
  ...
  const renderCalendarDay = useCallback((day, index) => {
