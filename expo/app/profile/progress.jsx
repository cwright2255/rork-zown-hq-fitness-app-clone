...
export default function ProgressTrackerScreen() {
  ...
  const { 
    ...
    updateCurrentTier: (xp) => void;
    getAvailableRewards: () => any[];
    getCurrentTierProgress: (xp) => number;
    getNextTierXp: () => number;
    upgradeToPremium: () => void;
    claimReward: (tierId, rewardId) => void;
  };
  ...
  const handleClaimReward = (tierId, rewardId) => {
    // Claim the reward
  ...
  const renderSectionTitle = (index) => {
