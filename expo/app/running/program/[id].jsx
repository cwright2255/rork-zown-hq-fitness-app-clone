...
export default function RunningProgramDetailScreen() {
  ...
  const getSessionStatus = (sessionIndex) => {
          ...
          <Card style={styles.infoCard}>
            ...
            <View style={styles.goalsContainer}>
              ...
              <View style={styles.goalsList}>
                {(program.goals || [program.goal]).filter((g): g is string => Boolean(g)).map((goal, index) => (
                  <Badge 
                    key={index}
                    variant="neutral"
