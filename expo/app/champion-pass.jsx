...
import { Award, Star, Lock, ChevronRight, ChevronLeft } from 'lucide-react-native';
...
export default function ChampionPassScreen() {
  ...
  const handleRewardsScroll = useCallback((event) => {
  ...
  const navigateRewards = useCallback((direction) => {
    const availableRewards = getAvailableRewards();
    if (direction === 'prev') {
