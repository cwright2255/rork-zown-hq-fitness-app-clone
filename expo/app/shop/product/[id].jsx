...
const styles = StyleSheet.create({
  ...
  image: { width: '100%', height: 300, backgroundColor: tokens.colors.darkNavy.text.primary },
  name: { fontSize: 28, fontWeight: '700', color: tokens.colors.darkNavy.background, letterSpacing: -0.5 },
  price: { fontSize: 22, fontWeight: '700', color: tokens.colors.darkNavy.background, marginTop: 8 },
  ratingRow: { flexDirection: 'row', alignItems: 'center', marginTop: 8, gap: 6 },
  rating: { color: tokens.colors.darkNavy.background, fontSize: 13, fontWeight: '600' },
  reviews: { color: tokens.colors.darkNavy.text.tertiary, fontSize: 13 },
  sectionLabel: {
  ...
  descText: { color: tokens.colors.darkNavy.background, fontSize: 14, lineHeight: 20 },
  expandHint: { color: tokens.colors.darkNavy.text.tertiary, fontSize: 12, marginTop: 8 },
