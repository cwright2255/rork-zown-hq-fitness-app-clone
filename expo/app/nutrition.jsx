    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={{ paddingBottom: 160 }}>
        ...
        <View style={styles.macroRow}>
          ...
          <View style={[styles.macroChip, { borderLeftColor: tokens.colors.red.base_f97 }]}>
            <Text style={styles.macroVal}>{Math.round(totals.carbs)}g</Text>
            <Text style={styles.macroLabel}>Carbs</Text>
          </View>
          <View style={[styles.macroChip, { borderLeftColor: tokens.colors.primary.base }]}>
...
const styles = StyleSheet.create({
  ...
  calCard: {
    ...
    borderWidth: 1, borderColor: tokens.colors.ink.darker,
    borderRadius: 16,
  ...
  foodRow: {
    ...
    paddingVertical: 10,
    borderBottomWidth: 1, borderBottomColor: tokens.colors.ink.darker,
  },
