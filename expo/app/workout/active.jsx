      ...
      {workoutComplete ?
        ...
        <SafeAreaView style={styles.completeContainer}>
          ...
          <View style={styles.statsContainer}>
            ...
            <>
                <View style={styles.statItem}>
                  <MapPin size={24} color={tokens.colors.background.default} />
                ...
                <View style={styles.statItem}>
                  <Heart size={24} color={tokens.colors.background.default} />
        ...
        <View style={styles.activeWorkoutContainer}>
          ...
          <Modal
            ...
            <View style={styles.modalOverlay}>
              <View style={styles.modalContent}>
                <MapPin size={48} color={tokens.colors.background.default} style={styles.permissionIcon} />
                ...
                <View style={styles.loadingContainer}>
                    <Loader2 size={24} color={tokens.colors.background.default} />
              ...
              <View style={styles.musicModalContent}>
                <View style={styles.musicModalHeader}>
                  ...
                  <TouchableOpacity onPress={() => setShowMusicPlayer(false)} testID="close-music-modal">
                    <X size={24} color={tokens.colors.background.default} />
                  </TouchableOpacity>
                </View>
                <SpotifyMusicPlayer
