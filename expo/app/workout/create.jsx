...
export default function CreateWorkoutScreen() {
  const { addWorkout } = useWorkoutStore() as { addWorkout: (workout) => void };
  const { updateAchievementProgress } = useAchievementStore() as { updateAchievementProgress: (id, progress) => void };
  ...
  const handleExerciseChange = (index, field: keyof ExerciseInput, value: string | number | string[]) => {
    const updatedExercises = [...exercises];
