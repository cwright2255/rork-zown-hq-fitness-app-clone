...
const CONVERSATIONS = [
  ...
  { id: '4', name: 'Emma Wilson', initials: 'EW', last: 'Smoothie recipe incoming 🥤', time: '1d', unread: 0 },
];
...
const styles = StyleSheet.create({
  ...
  bubbleOwn: { backgroundColor: '#fff', borderBottomRightRadius: 4 },
  bubbleOther: { backgroundColor: '#1A1A1A', borderWidth: 1, borderColor: '#2A2A2A', borderBottomLeftRadius: 4 },
  bubbleOwnText: { color: '#000', fontSize: 14 },
  bubbleOtherText: { color: '#fff', fontSize: 14 },
