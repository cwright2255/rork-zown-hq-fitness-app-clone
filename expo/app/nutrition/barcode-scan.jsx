...
const styles = StyleSheet.create({
  ...
  hint: { color: tokens.colors.dark_navy.text_primary, marginTop: tokens.spacing.md, fontSize: 14 },
  loadingOverlay: {
    position: 'absolute', inset: 0,
    backgroundColor: 'rgba(0,0,0,0.7)',
    alignItems: 'center', justifyContent: 'center',
  },
  loadingText: { color: tokens.colors.dark_navy.text_primary, marginTop: 12 },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center' },
  permWrap: { flex: 1, padding: tokens.spacing.lg, alignItems: 'center', justifyContent: 'center', gap: tokens.spacing.md },
  permTitle: { fontSize: 20, fontWeight: '700', color: tokens.colors.dark_navy.text_primary, textAlign: 'center' },
  ...
  productName: { fontSize: 22, fontWeight: '700', color: tokens.colors.dark_navy.text_primary },
  ...
  nutritionValue: { color: tokens.colors.dark_navy.text_primary, fontSize: 18, fontWeight: '700' },
