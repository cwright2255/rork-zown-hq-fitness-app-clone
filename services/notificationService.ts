...
class NotificationService {
  ...
  async sendWorkoutReminder(workoutName: string, scheduledTime: Date) {
    if (Platform.OS === 'web') {
      return;
    }
  ...
  async sendNutritionReminder(mealType: string, scheduledTime: Date) {
    if (Platform.OS === 'web') {
      return;
    }
  ...
  async sendSocialNotification(message: string) {
    if (Platform.OS === 'web') {
      return;
    }
